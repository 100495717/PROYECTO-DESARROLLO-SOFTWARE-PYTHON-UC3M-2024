...
class HotelManager:
    ...
    def validatecreditcard(self, x):
        ...
        if not checksum % 10 == 0:
            raise HotelManagementException("Invalid credit"
                                           " card number (not luhn)")
        return x
    ...
    def validate_numdays(self, num_days):
        ...
        if (days < 1 or days > 10):
            raise HotelManagementException("Numdays should be "
                                           "in the range 1-10")
        return num_days
    ...
    def validate_dni(dni):
        ...
        valid_format = {
            "0": "T", "1": "R", "2": "W", "3": "A", "4": "G",
            "5": "M", "6": "Y", "7": "F", "8": "P", "9": "D", "10":
            "X", "11": "B", "12": "N", "13": "J", "14": "Z",
            "15": "S", "16": "Q", "17": "V", "18": "H", "19":
            "L", "20": "C", "21": "K", "22": "E"}
        int_dni = int(dni[0:8])
    ...
    def read_data_from_json(self, file_input):
        """reads the content of a json file with
         two fields: CreditCard and phoneNumber"""
        try:
            ...
            raise HotelManagementException("JSON Decode "
                                           "Error - Wrong JSON Format") from e
        try:
            credit_card = json_data["CreditCard"]
            phone_number = json_data["phoneNumber"]
            request = HotelReservation(
                id_card="12345678Z",
